 ...
 *
 * Note that this function is hooked into the after_setup_theme hook, whichcus
 ...
 */
 require get_template_directory() . '/inc/footer-column.php';

/**
 * Enqueue scripts and styles.
 */
require get_template_directory() . '/inc/function-enque.php';
...
/**
 * footer customizer for social icons
 */
require get_template_directory() . '/inc/footer-custom.php';
 ...
 */
require get_template_directory() . '/inc/function-sliderpost.php';
...
* Register taxonoy
*/
require get_template_directory() . '/inc/function-taxonomy.php';
/**
* Register shortcode
*/
